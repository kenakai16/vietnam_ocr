...
class MyDataset(Dataset):
    def __init__(self,info_filename,train=True, transform=data_tf,target_transform=None,remove_blank = False,path_dir=None):
        ...
        for info_name in self.info_filename:
            with open(info_name) as f:
                ...
                for line in content:
                    ...
                    label = remove_special_charactor(label)
    ...
    def __getitem__(self, index):
        img = Image.open(self.path_dir + self.files[index])
...
def remove_special_charactor(string):
    string = re.sub('[||,@,&,$,#,%,…,\n,/,-,“,”,-,+]', ' ', string)
