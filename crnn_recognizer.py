...
if __name__ == '__main__':
    model_path = '/media/kenakai/AITeam/AI_TEAM/vietnam_ocr/weight/CRNN-4000-epooch.pth'
    recognizer = PytorchOcr(model_path)
    img_name   = '/media/kenakai/AITeam/AI_TEAM/vietnam_ocr/debug_files/00006.jpg'
